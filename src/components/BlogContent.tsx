...
const BlogContentInner = ( ) => {
  ...
  return (<><Head><title>{pageTitle}</title><meta name="description" content={pageDescription} /></Head><DropInBlogHead headData={headData} headItems={headItems} /><DropInBlogContent bodyHtml={bodyHtml} /></>);
};
