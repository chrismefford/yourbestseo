...
export const neighborhoodRoutes: RouteConfig[] = [
  ...
  { path: '/san-diego/carmel-valley-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/scripps-ranch-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/old-town-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/golden-hill-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/barrio-logan-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/bay-park-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/linda-vista-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/serra-mesa-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/tierrasanta-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/college-area-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/talmadge-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/rancho-penasquitos-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/midway-district-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/shelter-island-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/logan-heights-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/allied-gardens-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/san-carlos-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/convoy-district-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/paradise-hills-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/encanto-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/coronado-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/la-mesa-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/lemon-grove-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/spring-valley-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/poway-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/encinitas-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/solana-beach-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/carlsbad-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/oceanside-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/escondido-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/vista-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/san-marcos-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/lakeside-seo', priority: 0.7, changefreq: 'monthly' },
  { path: '/san-diego/alpine-seo', priority: 0.7, changefreq: 'monthly' },
